...
scripts_and_configs = [
    {
        "script": Path(r"E:\01_model_verification_analyses\diaphragm_models\model_01\run_nltha.py"),
        "config": [
            Path(r"E:\01_model_verification_analyses\diaphragm_models\model_01\config_nltha_120621_sf3500.py"),
        ]
    },
    {
        "script": Path(r"E:\01_model_verification_analyses\diaphragm_models\model_02\run_nltha.py"),
        "config": [
            Path(r"E:\01_model_verification_analyses\diaphragm_models\model_02\config_nltha_120621_sf3500.py"),
        ]
    },
]
