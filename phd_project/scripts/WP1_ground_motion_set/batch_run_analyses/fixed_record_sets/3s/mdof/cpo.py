...
scripts_and_configs = [
    {
        "script": Path("D:/08_wp1_fixed_record_sets/group_3s_00/3s/mdof/run_cyclic_pushover.py"),
        "config": [Path('D:/08_wp1_fixed_record_sets/group_3s_00/3s/mdof/config_cyclic_pushover.py')],
        "name": ['group_3s_00_cpo']
    },
    # {
    #     "script": Path("D:/08_wp1_fixed_record_sets/group_3s_01/3s/mdof/run_cyclic_pushover.py"),
    #     "config": [Path('D:/08_wp1_fixed_record_sets/group_3s_01/3s/mdof/config_cyclic_pushover.py')],
    #     "name": ['group_3s_01_cpo']
    # },
    # {
    #     "script": Path("D:/08_wp1_fixed_record_sets/group_3s_02/3s/mdof/run_cyclic_pushover.py"),
    #     "config": [Path('D:/08_wp1_fixed_record_sets/group_3s_02/3s/mdof/config_cyclic_pushover.py')],
    #     "name": ['group_3s_02_cpo']
    # },
    # {
    #     "script": Path("D:/08_wp1_fixed_record_sets/group_3s_03/3s/mdof/run_cyclic_pushover.py"),
    #     "config": [Path('D:/08_wp1_fixed_record_sets/group_3s_03/3s/mdof/config_cyclic_pushover.py')],
    #     "name": ['group_3s_03_cpo']
    # },
    # {
    #     "script": Path("D:/08_wp1_fixed_record_sets/group_3s_04/3s/mdof/run_cyclic_pushover.py"),
    ...
    #     "name": ['group_3s_08_cpo']
    # },
    # {
    #     "script": Path("D:/08_wp1_fixed_record_sets/group_3s_09/3s/mdof/run_cyclic_pushover.py"),
    #     "config": [Path('D:/08_wp1_fixed_record_sets/group_3s_09/3s/mdof/config_cyclic_pushover.py')],
    #     "name": ['group_3s_09_cpo']
    # },
    # {
    #     "script": Path("D:/08_wp1_fixed_record_sets/group_3s_10/3s/mdof/run_cyclic_pushover.py"),
    #     "config": [Path('D:/08_wp1_fixed_record_sets/group_3s_10/3s/mdof/config_cyclic_pushover.py')],
    #     "name": ['group_3s_10_cpo']
    # },
    # {
    #     "script": Path("D:/08_wp1_fixed_record_sets/group_3s_11/3s/mdof/run_cyclic_pushover.py"),
    #     "config": [Path('D:/08_wp1_fixed_record_sets/group_3s_11/3s/mdof/config_cyclic_pushover.py')],
    #     "name": ['group_3s_11_cpo']
    # },
    # {
    #     "script": Path("D:/08_wp1_fixed_record_sets/group_3s_12/3s/mdof/run_cyclic_pushover.py"),
    #     "config": [Path('D:/08_wp1_fixed_record_sets/group_3s_12/3s/mdof/config_cyclic_pushover.py')],
    #     "name": ['group_3s_12_cpo']
    # },
    # {
    #     "script": Path("D:/08_wp1_fixed_record_sets/group_3s_13/3s/mdof/run_cyclic_pushover.py"),
    ...
    #     "name": ['group_3s_19_cpo']
    # },
    # {
    #     "script": Path("D:/08_wp1_fixed_record_sets/group_3s_20/3s/mdof/run_cyclic_pushover.py"),
    #     "config": [Path('D:/08_wp1_fixed_record_sets/group_3s_20/3s/mdof/config_cyclic_pushover.py')],
    #     "name": ['group_3s_20_cpo']
    # },
    # {
    #     "script": Path("D:/08_wp1_fixed_record_sets/group_3s_21/3s/mdof/run_cyclic_pushover.py"),
    #     "config": [Path('D:/08_wp1_fixed_record_sets/group_3s_21/3s/mdof/config_cyclic_pushover.py')],
    #     "name": ['group_3s_21_cpo']
    # },
    # {
    #     "script": Path("D:/08_wp1_fixed_record_sets/group_3s_22/3s/mdof/run_cyclic_pushover.py"),
    #     "config": [Path('D:/08_wp1_fixed_record_sets/group_3s_22/3s/mdof/config_cyclic_pushover.py')],
    #     "name": ['group_3s_22_cpo']
    # },
    # {
    #     "script": Path("D:/08_wp1_fixed_record_sets/group_3s_23/3s/mdof/run_cyclic_pushover.py"),
    #     "config": [Path('D:/08_wp1_fixed_record_sets/group_3s_23/3s/mdof/config_cyclic_pushover.py')],
    #     "name": ['group_3s_23_cpo']
    # },
    # {
    #     "script": Path("D:/08_wp1_fixed_record_sets/group_3s_24/3s/mdof/run_cyclic_pushover.py"),
    #     "config": [Path('D:/08_wp1_fixed_record_sets/group_3s_24/3s/mdof/config_cyclic_pushover.py')],
    #     "name": ['group_3s_24_cpo']
    # }
]
