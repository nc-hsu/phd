...
scripts_and_configs = [
    {
        "script": Path("E:/02_wp1pt4pt1_po_analyses_for_sdof_fitting/3s_cbf_dc2_41/run_cyclic_pushover.py"),
        "config": [Path('E:/02_wp1pt4pt1_po_analyses_for_sdof_fitting/3s_cbf_dc2_41/config_cyclic_pushover.py'),
                   Path('E:/02_wp1pt4pt1_po_analyses_for_sdof_fitting/3s_cbf_dc2_41/config_cyclic_pushover_2.py'),
                   Path('E:/02_wp1pt4pt1_po_analyses_for_sdof_fitting/3s_cbf_dc2_41/config_cyclic_pushover_3.py')]
    },

    {
        "script": Path("E:/02_wp1pt4pt1_po_analyses_for_sdof_fitting/3s_cbf_dc2_41_fitB_sdof/run_cyclic_pushover.py"),
        "config": [Path('E:/02_wp1pt4pt1_po_analyses_for_sdof_fitting/3s_cbf_dc2_41_fitB_sdof/config_cyclic_pushover.py'),
                   Path('E:/02_wp1pt4pt1_po_analyses_for_sdof_fitting/3s_cbf_dc2_41_fitB_sdof/config_cyclic_pushover_2.py'),
                   Path('E:/02_wp1pt4pt1_po_analyses_for_sdof_fitting/3s_cbf_dc2_41_fitB_sdof/config_cyclic_pushover_3.py')]
    }
]
