...
Abrahamson et al. (2016), BC Hydro Ground Motion Predictions Equations for
Subduction Earthquakes, Earthquake Spectra. 32(1). 23-44.
https://journals.sagepub.com/doi/full/10.1193/051712EQS188MR
"""
import numpy as np
import pandas as pd

# Data from Table A4 of the supplementary material:
# Correlation data for the total residual
data = np.array([
    [1.000, 0.959, 0.938, 0.930, 0.930, 0.910, 0.887, 0.858, 0.817, 0.729, 0.648, 0.580, 0.464, 0.391, 0.309, 0.274, 0.280, 0.223, 0.231],
...
periods = np.array([0.01, 0.05, 0.075, 0.10, 0.15, 0.20, 0.25, 0.30, 0.40, 0.50, 0.60, 
           0.75, 1.0, 1.5, 2.0, 2.5, 3.0, 4.0, 5.0])

labels = [("GM", "SA", t) for t in periods]

def aga16_empirical_correlation_model():
