...
# =============================================================================
# initialise_model -- FULL recorder set
# =============================================================================
# Defines *how one analysis is initialised*: it builds the model, applies damping
# and creates the full recorder set, then exposes a single zero-argument
# `model_init` that the analysis config imports (via `model_file_name`).
#
...
# swapped via `config_structural_model_file_name`. Which of the model configs
# defined there is used is pinned by `model_config_name` -- each initialise_model
# file is therefore unique to one analysis config.
#
# NOTE: `add_limit_state_recorders` below is shared verbatim with
# `template_initialise_model_nlcbf_nlthareduced.py`. If you change the recorder-
# construction logic, edit BOTH templates. The ONLY difference between this file
# and the reduced one is that the reduced one passes the full recorder list
# through `_reduce_recorders(...)` inside `generate_recorders`.
# =============================================================================
