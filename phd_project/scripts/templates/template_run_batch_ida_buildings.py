...
buildings: list[dict[str, str]] = [
    {"folder": r"E:\03_wp1pt4pt1_dc2_sdof_fitting\3s_cbf_dc2_10_sdof",
     "config": "config_ida_htf_femap695_set.py"},
    {"folder": r"E:\03_wp1pt4pt1_dc2_sdof_fitting\3s_cbf_dc2_20_sdof",
     "config": "config_ida_htf_femap695_set.py"},
    {"folder": r"E:\03_wp1pt4pt1_dc2_sdof_fitting\3s_cbf_dc2_31_sdof",
     "config": "config_ida_htf_femap695_set.py"},
]
