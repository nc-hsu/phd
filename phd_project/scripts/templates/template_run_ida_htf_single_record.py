...
if __name__ == "__main__":
    ...
    #   python run_ida_htf_single_record.py config_ida_htf_single_record.py
    parser = argparse.ArgumentParser(description="Run an IDA for a single building and a single record.")
    parser.add_argument("config", nargs="?", default="config_ida_htf_single_record.py",
